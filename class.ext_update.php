<?php
namespace SJBR\StaticInfoTablesCs;
...
class ext_update
{
	...
	public function main()
	{
		...
		$databaseUpdateUtility->doUpdate('static_info_tables_cs');

		$content.= '<p>' . LocalizationUtility::translate('updateLanguageLabels', 'StaticInfoTables') . ' static_info_tables_cs.</p>';
		return $content;
	}
